...
var cpuLine = grid.set(0, 0, 4, 8, contrib.line, {
  showNthLabel: 5,
  maxY: 125,
  label: 'CPU History',
  showLegend: true,
...
var memDonut = grid.set(8, 4, 2, 4, contrib.donut, {
  radius: 8,
  arcWidth: 3,
  yPadding: 2,
  remainColor: 'black',
...
var swapDonut = grid.set(10, 4, 2, 4, contrib.donut, {
  radius: 8,
  arcWidth: 3,
  yPadding: 2,
  remainColor: 'black',
...
var netSpark = grid.set(10, 0, 2, 4, contrib.sparkline, {
...
var diskDonut = grid.set(8, 0, 2, 4, contrib.donut, {
  radius: 8,
  arcWidth: 3,
  yPadding: 2,
  remainColor: 'black',
...
var procTable = grid.set(0, 8, 12, 4, contrib.table, {
  keys: true,
  label: 'Processes',
  columnSpacing: 1,
